method XML_ADD_INFO_VIEW.
  ...
  io_xml_document->set_attribute( name = 'type' value = y00cacl_abapdoc_wdc_comp=>co_wdc_type_view node = lo_xml_node_2col ).
...
* Plug Include on root View
    LOOP AT gt_my_vsh_nodes ASSIGNING <fs_vsh_nodes> WHERE pholder_owner = is_my_vsh_node-vsh_node_name.
